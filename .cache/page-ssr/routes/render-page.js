...
var React = _interopRequireWildcard(__webpack_require__(1148));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(1148);
...
var _react = _interopRequireDefault(__webpack_require__(1148));
...
exports.components={"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 218).then(__webpack_require__.bind(__webpack_require__, 2513)),"component---src-pages-index-tsx":()=>Promise.all(/* import() | component---src-pages-index-tsx */[__webpack_require__.e(635), __webpack_require__.e(206), __webpack_require__.e(691)]).then(__webpack_require__.bind(__webpack_require__, 7200)),"component---src-pages-layout-tsx":()=>Promise.all(/* import() | component---src-pages-layout-tsx */[__webpack_require__.e(635), __webpack_require__.e(206)]).then(__webpack_require__.bind(__webpack_require__, 3433)),"component---src-pages-productos-tsx":()=>Promise.all(/* import() | component---src-pages-productos-tsx */[__webpack_require__.e(635), __webpack_require__.e(95), __webpack_require__.e(206), __webpack_require__.e(755)]).then(__webpack_require__.bind(__webpack_require__, 2675)),"component---src-pages-quienes-somos-tsx":()=>Promise.all(/* import() | component---src-pages-quienes-somos-tsx */[__webpack_require__.e(635), __webpack_require__.e(206), __webpack_require__.e(799)]).then(__webpack_require__.bind(__webpack_require__, 6935)),"component---src-pages-servicios-tsx":()=>Promise.all(/* import() | component---src-pages-servicios-tsx */[__webpack_require__.e(635), __webpack_require__.e(206), __webpack_require__.e(410)]).then(__webpack_require__.bind(__webpack_require__, 4992))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(2588),options:{"plugins":[]}},{name:'gatsby-plugin-google-gtag',plugin:__webpack_require__(4303),options:{"plugins":[],"trackingIds":["G-X6X6TD6RP5"],"gtagConfig":{"anonymize_ip":true,"cookie_expires":0},"pluginConfig":{"head":true,"respectDNT":true,"exclude":["/preview/**","/do-not-track/**"],"origin":"https://www.googletagmanager.com","delayOnRouteUpdate":0}}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5822),options:{"plugins":[],"icon":"src/images/icon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"fbc1a8da0fb3bbba3f1653b38e05195a"}},{name:'gatsby-plugin-klaro',plugin:__webpack_require__(5621),options:{"plugins":[],"includeInDevelopment":true,"klaroVersion":"v0.7.11","config":{"lang":"es","privacyPolicy":"../src/images","services":[{"trackingId":"G-X6X6TD6RP5","name":"google-analytics","default":true,"title":"Google Analytics and others","purposes":["statistics"],"cookies":[{}]}]}}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
// EXTERNAL MODULE: external "/Users/juanpablo/copygraphos/node_modules/react/index.js"
var index_js_ = __webpack_require__(1148);
...
const React=__webpack_require__(1148);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(293);const{parse}=__webpack_require__(698);const styleToOjbect=__webpack_require__(7848);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);var _react=_interopRequireDefault(__webpack_require__(1148));var DEFAULT_VERSION="v0.7.11";var DEFAULT_URL="https://cdn.kiprotect.com/klaro/%version%/klaro.js";exports.onRenderBody=function(_ref,pluginOptions){var setHeadComponents=_ref.setHeadComponents;if(true){var klaroComponents=[];var klaroVersion=pluginOptions.klaroVersion,klaroUrl=pluginOptions.klaroUrl,config=pluginOptions.config,configUrl=pluginOptions.configUrl;// Prepare config
var configurationComponent;if(configUrl!==undefined){configurationComponent=/*#__PURE__*/_react.default.createElement("script",{defer:true,key:"klaro-config",type:"text/javascript",src:configUrl});}if(config!==undefined){var configAsString="window.klaroConfig = "+JSON.stringify(config);configurationComponent=/*#__PURE__*/_react.default.createElement("script",{key:"klaro-config",type:"text/javascript",dangerouslySetInnerHTML:{__html:""+configAsString}});}if(configurationComponent!==undefined){klaroComponents.push(configurationComponent);}// Prepare Klaro
var urlToUse=klaroUrl?klaroUrl:DEFAULT_URL;var versionToUse=klaroVersion?klaroVersion:DEFAULT_VERSION;var finalKlaroUrl=urlToUse.replace("%version%",versionToUse);var urlComponent=/*#__PURE__*/_react.default.createElement("script",{defer:true,key:"klaro",type:"text/javascript",src:finalKlaroUrl});klaroComponents.push(urlComponent);// Add components
return setHeadComponents(klaroComponents);}return null;};
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);var React=_interopRequireWildcard(__webpack_require__(1148));var _gatsby=__webpack_require__(7076);var _common=__webpack_require__(5428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(1148),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/juanpablo/copygraphos/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/juanpablo/copygraphos/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/juanpablo/copygraphos/node_modules/react/index.js");
...
/******/ 			return "" + ({"206":"component---src-pages-layout-tsx","218":"component---src-pages-404-tsx","410":"component---src-pages-servicios-tsx","691":"component---src-pages-index-tsx","755":"component---src-pages-productos-tsx","799":"component---src-pages-quienes-somos-tsx"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(1148);const path=__webpack_require__(1423);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(293);const{ServerLocation,Router,isRedirect}=__webpack_require__(7896);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7076);const fs=__webpack_require__(3500);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const{headHandlerForSSR}=__webpack_require__(923);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(8995);const{ServerSliceRenderer}=__webpack_require__(7529);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
